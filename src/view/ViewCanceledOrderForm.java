...
public class ViewCanceledOrderForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        canceledOrderTbl = new javax.swing.JTable();
        ...
        canceledOrderTbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(canceledOrderTbl);
    ...
    private void reloadBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reloadBtnActionPerformed
        try {
            ...
            DefaultTableModel dtm=(DefaultTableModel)canceledOrderTbl.getModel();
            dtm.setRowCount(0);
            boolean have=false;
            for (int i = 0; i < burger.length; i++) {
                if(burger[i].getStatus()==2){
                    have=true;
    ...
    private javax.swing.JTable canceledOrderTbl;
